...
Interactive Quarto HTML documents and dashboards use
[`quarto_setup()`](https://csiontario.github.io/csiapps-r/reference/quarto_setup.md)
in Quarto’s standard `server.R` together with the language-neutral
`csiapps-quarto` extension. See the [Quarto
guide](https://csiontario.github.io/csiapps/quarto-docs/) for CSI login,
protected delivery, and Connect Cloud deployment.
